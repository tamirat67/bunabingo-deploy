  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <button 
          onClick={onClose}
          className="w-full mt-5 bg-gradient-to-r from-green-500 to-green-600 text-white font-black py-3 rounded-xl shadow-[0_4px_0_#166534] active:translate-y-1 active:shadow-none transition-all tracking-wider"
        >
          ገብቶኛል፣ እንጀምር!
        </button>
      </div>
